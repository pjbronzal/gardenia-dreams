...
const products = [
	{
	  ...
	  image1: "/images/flowers_1/Alluring Elegance Bouquet.jpg",
	  image2: "/images/flowers_1/Alluring Elegance Bouquet_1.jpg",
  ...
  function renderProducts() {
	...
	products.forEach(product => {
	  ...
	  productCard.className = 'single-item swiper-slide';
